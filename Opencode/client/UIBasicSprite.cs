		...
		for (int j = 0; j < 3; j++)
		{
			...
			for (int k = 0; k < 3; k++)
			{
				...
				else if (j == 1)
				{
					...
					else if ((k == 0 && bottomType != AdvancedType.Invisible) || (k == 2 && topType != AdvancedType.Invisible))
					{
						Fill(verts, uvs, cols, mTempPos[j].x, mTempPos[num2].x, mTempPos[k].y, mTempPos[num3].y, mTempUVs[j].x, mTempUVs[num2].x, mTempUVs[k].y, mTempUVs[num3].y, col);
					}
				}
				else if (k == 1)
				{
					...
					else if ((j == 0 && leftType != AdvancedType.Invisible) || (j == 2 && rightType != AdvancedType.Invisible))
					{
						Fill(verts, uvs, cols, mTempPos[j].x, mTempPos[num2].x, mTempPos[k].y, mTempPos[num3].y, mTempUVs[j].x, mTempUVs[num2].x, mTempUVs[k].y, mTempUVs[num3].y, col);
					}
				}
				else if ((k == 0 && bottomType != AdvancedType.Invisible) || (k == 2 && topType != AdvancedType.Invisible) || (j == 0 && leftType != AdvancedType.Invisible) || (j == 2 && rightType != AdvancedType.Invisible))
				{
					Fill(verts, uvs, cols, mTempPos[j].x, mTempPos[num2].x, mTempPos[k].y, mTempPos[num3].y, mTempUVs[j].x, mTempUVs[num2].x, mTempUVs[k].y, mTempUVs[num3].y, col);
				}
			}
