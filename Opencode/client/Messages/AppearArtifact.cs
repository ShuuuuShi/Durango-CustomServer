...
public struct AppearArtifact
{
	...
	{
		return $"<AppearArtifact EntityId={EntityId} EntityType={EntityType} IsAlive={IsAlive} Tile={Tile} Size={Size} Height={Height} Floor={Floor} Stories={Stories} HasRoof={HasRoof} Rotation={Rotation} Display={Display} Tags={Tags} States={States} FounderEntityId={FounderEntityId}>";
	}
}
