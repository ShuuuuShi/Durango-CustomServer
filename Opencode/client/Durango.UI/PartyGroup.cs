...
public class PartyGroup : UIBase
{
	...
	private void Start()
	{
		...
		{
			bool flag = !_electLeader.Selected;
			_electLeader.Selected = flag;
			for (int i = 0; i < _scrollView.Nodes.Count; i++)
			{
				...
				component.ToggleElectLeader(flag);
			}
		});
