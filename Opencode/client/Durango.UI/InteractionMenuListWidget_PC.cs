...
public class InteractionMenuListWidget_PC : InteractionMenuListWidgetBase
{
	...
	public override void Init()
	{
		...
		for (int num = 0; num < base.VisibleCountPerPage; num++)
		{
			int count = num;
	...
	private void RepositionMenuItems()
	{
		...
		for (int num2 = count; num2 < max; num2++)
		{
	...
	private void RepositionMenuItem(InteractionMenuWidget_PC menuWidget)
	{
		...
		float num2 = ((menuWidget.Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
