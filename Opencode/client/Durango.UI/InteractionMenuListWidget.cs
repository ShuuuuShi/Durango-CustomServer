...
public class InteractionMenuListWidget : InteractionMenuListWidgetBase
{
	...
	private void RepositionMenuItems()
	{
		...
		for (int k = 0; k < count; k++)
		{
			...
			float num7 = ((interactionMenuWidgetBase3.Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
	...
	private void RepositionMenuMultipleLines(float radius, int eraseWidth)
	{
		...
		for (int visibleCountPerPage = base.VisibleCountPerPage; i < visibleCountPerPage; i++)
		{
			...
			if (num4 != -1)
			{
				...
				float num5 = ((interactionMenuWidgetBase.Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
			...
			if (num4 != -1)
			{
				...
				float num7 = ((interactionMenuWidgetBase2.Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
	...
	private void RepositionMenuOneLine(float radius, int eraseWidth)
	{
		...
		float num = ((interactionMenuWidgetBase.Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
		_linkLineContainer.SetActive(value: true);
