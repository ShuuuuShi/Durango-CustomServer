...
public class ResearchTierWidget : MonoBehaviour
{
	...
	public LaboratoryTier Tier => _tier ?? LaboratoryTier.Invalid;
	...
	private void OnResearchClick()
	{
		...
		if (!(researchNodeWidget == null) && ResearchClicked != null)
		{
			ResearchClicked(researchNodeWidget.Key, researchNodeWidget.PioneerGrade);
		}
	}
