	...
	void IUIInitializable.Init()
	{
		...
		for (int i = 0; i < values.Count; i++)
		{
			...
			case AllyState.Suggested:
				...
				{
					ClanAllyWidget component = obj.GetComponent<ClanAllyWidget>();
					component.ButtonClicked = _parent.SuggestAllyCancel;
				});
				break;
			case AllyState.BeenSuggested:
				...
				{
					ClanAllyWidget component = obj.GetComponent<ClanAllyWidget>();
					component.ButtonClicked = _parent.BeenSuggestedAlly;
				});
				break;
			case AllyState.BreakSuggested:
				...
				{
					ClanAllyWidget component = obj.GetComponent<ClanAllyWidget>();
					component.ButtonClicked = _parent.BreakAlly;
				});
				break;
			case AllyState.BeenBreakSuggested:
				...
				{
					ClanAllyWidget component = obj.GetComponent<ClanAllyWidget>();
					component.ButtonClicked = _parent.BeenBreakSuggestedAlly;
				});
				break;
			case AllyState.Empty:
				values[i].Pool.Init(delegate(GameObject obj)
				{
					ClanAllyEmptyWidget component = obj.GetComponent<ClanAllyEmptyWidget>();
					component.ButtonClicked = OnClickEmptyWidget;
				});
				break;
			default:
