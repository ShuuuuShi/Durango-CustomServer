...
public class EncyclopediaGroup : UIBase
{
	...
	private void InitializeTab()
	{
		...
		if (role != Role.Tutorial && role != Role.Safehouse && GameManager.ClusterMode == Mode.Online)
		{
			...
			_categories.Sort((KeyValuePair<EncyclopediaType, EncyclopediaCategory> keyValuePair, KeyValuePair<EncyclopediaType, EncyclopediaCategory> keyValuePair2) => keyValuePair.Value.Order - keyValuePair2.Value.Order);
		}
		_tabList.BeginLoad();
