...
public class RepairKitsWidget : MonoBehaviour
{
	...
	{
		if (_recipeId != null && JumpToRecipeUIButtonClicked != null)
		{
			JumpToRecipeUIButtonClicked(_recipeId);
		}
	}

	private void ButtonJumpToMarketUI_Clicked()
	{
		if (JumpToMarketUIButtonClicked != null)
		{
			JumpToMarketUIButtonClicked(_tagIdForRepairKit);
		}
	}
}
