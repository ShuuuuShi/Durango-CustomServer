...
public class EmotionContentWidget : UIWidget
{
	...
	public Vector2 UpdateLayoutItems()
	{
		...
		Vector2 vector2 = UIUtility.WidgetsGridReposition(_subjectItems, null, Vector2.down, vector, viewSize.x - _padding.x * 2f, _subjectItems.BaseObject.localSize, _padding.x, _padding.y, out var rowItemCount, out var rowSize, out var colSize);
