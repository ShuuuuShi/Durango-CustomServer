...
public class Commodity : IComparable<Commodity>
{
	...
	{
		if ((SalesTag & Shared.Purchaser.Tags.Discounted) != Shared.Purchaser.Tags.None && Data.OriginalPriceAmount > 0)
		{
	...
	public ItemIcon GetIcon(bool large)
	{
		...
		if (string.IsNullOrEmpty(text) && KUtility.GetSize(ContentDescriptions) > 0)
		{
			...
			return new ItemIcon
			{
				Main = contentDescription.Icon,
				Colors = contentDescription.IconColor
			};
		}
		return new ItemIcon
		{
