...
public class QuestSystem : GameSystem<QuestSystem>
{
	...
	private void OnQuestScoreInfos(QuestScoreInfos msg)
	{
		...
		if (QuestScoreInfosUpdated != null)
		{
			QuestScoreInfosUpdated(msg);
		}
	}
	...
	private void OnQuestStarted(QuestStarted msg, PacketHeader header)
	{
		...
		for (int size = KUtility.GetSize(msg.Quests); i < size; i++)
		{
			...
			if (questYml != null && !string.IsNullOrEmpty(questYml.ChapterSubject) && ChapterStarted != null)
			{
				ChapterStarted(quest.Id);
			}
		}
		UpdateNotification();
	}
	...
	{
		if (QuestCategoryChanged != null)
		{
			QuestCategoryChanged(category.Key);
		}
	}
	...
	private void UpdateNotification()
	{
		...
		if (QuestNotificationUpdated != null)
		{
			QuestNotificationUpdated(obj);
		}
	}
