...
public static class TerrainLoader
{
	public static TerrainData Load(string terrainId)
	{
		...
		{
			TerrainInfoJson terrainInfoJson = new TerrainInfoJson();
			terrainInfoJson.tile_count = new int[2] { 256, 256 };
			terrainInfoJson.lake_biome = "grassland";
			terrainInfoJson.ocean_biome = "warm_ocean";
			terrainInfoJson.river_biome = "temperate_forest";
			terrainInfoJson.color_set = "grassland";
			terrainInfoJson.region_template = "pe10gr_1";
			terrainInfoJson.tile_set = "grassland";
			terrainInfoJson.entry_points = new int[1][] { new int[2] { 63, 71 } };
			terrainData.Info = terrainInfoJson;
		}
