...
public class AssetBundleManager : Singleton<AssetBundleManager>
{
	...
	public void ClearAll()
	{
		...
		BackgroundDownloadStarted = null;
		BackgroundDownloadCompleted = null;
	}
	...
	{
		if (BackgroundDownloadStarted != null)
		{
			BackgroundDownloadStarted();
		}
		if (!UseBundle)
		{
			_isBackgroundDownloading = false;
		...
		if (BackgroundDownloadCompleted != null)
		{
