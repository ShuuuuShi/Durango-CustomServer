...
public class ModelComponent : ModelComponent.IModel
{
	...
	{
		if (!IsSetting() && !IsLoading(out var isSuccess) && LoadCompleted != null)
		{
			LoadCompleted(isSuccess);
		}
	}
	...
	public IModel SetDamaged(float damageRatio)
	{
		...
		if (MaterialPropertyChanged != null)
		{
