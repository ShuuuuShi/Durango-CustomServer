...
public class DamageWidgetIndicators : MonoBehaviour
{
	...
	private void OnDamaged(Damaged damaged)
	{
		...
		DamageableEntity damageableEntity = damageableEntities.Get(damaged.VictimId, out var isAlly);
		if (damageableEntity == null)
		{
			return;
		}
		DamageableEntity damageableEntity2 = damageableEntities.Get(damaged.AttackerId, out var isAlly2);
