...
public abstract class TerrainChunkBase : MonoBehaviour
{
	...
	private void LoadWaterTiles(WaterData oceanData, RiverData riverData)
	{
		...
		WaterData.WaterMask waterMask = oceanData.CreateWaterMask(out var tileExist, isOcean: true, riverData, base.transform.position);
		WaterData.WaterMask waterMask2 = oceanData.CreateWaterMask(out var tileExist2, isOcean: false, riverData);
		if (waterMask != null)
		{
	...
	private void LoadRiverData(RiverData riverData)
	{
		...
		RiverData.RiverMask riverMask = riverData.CreateRiverMask(out var riverTileExist);
		if (riverMask != null)
		{
