...
public class MemberRoleEditWidget : UIWidget
{
	...
	private void OnClickPermissionCheck()
	{
		...
		if (num != -1)
		{
			...
			modifiedPermissions = (((modifiedPermissions & permissions) != Permissions.None) ? (modifiedPermissions & ~permissions) : (modifiedPermissions | permissions));
