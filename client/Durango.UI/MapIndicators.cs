...
public class MapIndicators : Durango.Utils.Singleton<MapIndicators>
{
	...
	private void OnClickIndicator(GameObject obj)
	{
		...
		if (mapIndicator != null && IndicatorClicked != null)
		{
			IndicatorClicked(mapIndicator);
	...
	{
		if (chat.MsgType != ChatStruct.ChatMsgType.Talk || !MapPositionParser.TryGetPosition(chat.FindText(), out var humaneX, out var humaneY))
		{
			return;
		}
