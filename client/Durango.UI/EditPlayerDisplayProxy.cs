...
public class EditPlayerDisplayProxy
{
	...
	public PlayerDisplay MakeDisplay()
	{
		return new PlayerDisplay
		{
			...
			PortraitBgColor = NGUIText.EncodeColor(PortraitBgColor),
			VoiceType = VoiceType,
			BodySize = BodySize,
			BodyColor = new string[3]
			{
				NGUIText.EncodeColor(BodyColor1),
				NGUIText.EncodeColor(BodyColor2),
				NGUIText.EncodeColor(BodyColor3)
			},
			HeadColor = new string[3]
			{
				NGUIText.EncodeColor(HeadColor1),
				NGUIText.EncodeColor(HeadColor2),
				NGUIText.EncodeColor(HeadColor3)
			},
			SkinColor = NGUIText.EncodeColor(SkinColor),
			HairColor = NGUIText.EncodeColor(HairColor),
			EyeColor = NGUIText.EncodeColor(EyeColor),
			LipColor = NGUIText.EncodeColor(LipColor),
			Hair = Hair,
			Beard = Beard,
			Head = Head,
			Body = Body
	...
	{
		return new ChangePlayerDisplay
		{
