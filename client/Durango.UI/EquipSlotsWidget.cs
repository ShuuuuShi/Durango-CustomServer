...
public class EquipSlotsWidget : UIWidget, IUIInitializable
{
	...
	void IUIInitializable.Init()
	{
		...
		int num = 0;
		for (int length = values.Length; num < length; num++)
		{
			EquipSystem.Slot slot = (EquipSystem.Slot)values.GetValue(num);
	...
	private void OnClickSlot(GameObject obj)
	{
		...
		if (num != -1)
		{
			...
			if (component != null && SlotClicked != null)
			{
				SlotClicked(component.Slot);
			}
		}
	}
