...
public class PurchasedListWidget : UIWidget
{
	...
	private void UpdateLayout()
	{
		...
		Vector2 vector2 = UIUtility.WidgetsGridReposition(_results, null, Vector2.down, Vector3.zero, vector.x, baseNodeSize, rowMargin, colMargin, out var _, out var _, out var _);
