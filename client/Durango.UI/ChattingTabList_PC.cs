...
public class ChattingTabList_PC : MonoBehaviour, IUIInitializable
{
	...
	{
		if (FilterTabClicked != null)
		{
			FilterTabClicked(filter);
		}
	}

	private void ClickRoomTab(Conversation conv)
	{
		if (ChatRoomClicked != null)
		{
			ChatRoomClicked(conv);
		}
	}
	...
	private void LateUpdate()
	{
		...
		{
			_hasUnreadTab = flag;
			if (NotificationStateChanged != null)
			{
				NotificationStateChanged(_hasUnreadTab);
			}
		}
	}
}
