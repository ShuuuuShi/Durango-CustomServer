...
public class DomesticCagePetInfoWidget : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			if (DomesticateStarted != null)
			{
				DomesticateStarted(_target);
			}
		});
		...
		{
			if (DomesticateStoped != null)
			{
				DomesticateStoped(_target);
			}
		});
	...
	private void OnActionButtonClick()
	{
		...
		{
		case CageStatus.Complete:
			if (DomesticateFinished != null)
			{
				DomesticateFinished(_target);
			}
			break;
		case CageStatus.Domesticated:
			if (ReinTookOut != null)
