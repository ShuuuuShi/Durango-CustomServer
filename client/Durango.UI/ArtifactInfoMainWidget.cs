...
public class ArtifactInfoMainWidget : MonoBehaviour
{
	...
	{
		if (ArtifactStatsInfoClicked != null)
		{
			ArtifactStatsInfoClicked(StatsType.Comfort);
		}
	}
	...
	private void OnClickAntibacterialStats()
	{
		if (ArtifactStatsInfoClicked != null)
		{
			ArtifactStatsInfoClicked(StatsType.Antibacterial);
		}
	}
