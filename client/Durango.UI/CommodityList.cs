...
public class CommodityList : MonoBehaviour, IScreenResizeReceiver
{
	...
	private static readonly ProductSortField[] SortFieldsByTime = new ProductSortField[3]
	{
	...
	private void RefreshSelectableColumns()
	{
		...
		{
			CommoditySelectableColumn commoditySelectableColumn = _selectableColumns[i];
			commoditySelectableColumn.SetState((commoditySelectableColumn.Value == _savedSortField) ? _savedSortState : SortableColumnWidget<ProductSortField>.State.None);
		}
	}
