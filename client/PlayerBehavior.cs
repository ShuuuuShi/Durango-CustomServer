...
public class PlayerBehavior : CharacterBehavior, IAnimationEventPlayable, ICostumable, IMotionPlayable
{
	...
	public PortraitBuilder.Argument GetPortraitArgument()
	{
		...
		return new PortraitBuilder.Argument
		{
			Preset = Display.PortraitIcon
		};
	}
	...
	{
		if (MotionConditionChanged != null)
		{
			MotionConditionChanged();
		}
	}
	...
	public void SetMusician(Musician? musician)
	{
		...
		float num = (float)((!playedAt.HasValue) ? ((double?)null) : new double?(Connections.Frontend.GetBufferedServerTime() - playedAt.GetValueOrDefault())).Value;
