...
/// • **สัตว์ยังไม่เดิน** — ไม่มี AI ยืนนิ่งอยู่กับที่ · ต้องมี tick + pathfinding ซึ่งเป็นงานก้อนถัดไป
/// • **ยังไม่คัดตามระยะ (chunk culling)** — ส่งสัตว์ทั้งเกาะให้ตอนเข้าเกม เพราะจุดที่ควรคัด
///   อยู่ใน <c>Player.SetCenterChunks</c> ซึ่งตอนเขียนไฟล์นี้มีคนอื่นถืออยู่
///   ⇒ จึงจำกัดจำนวนที่เกิดต่อเกาะแทน (<see cref="MaxAnimalsPerRegion"/>) ให้เกมไม่แบก
/// • ยังไม่เซฟ — สัตว์ตายแล้วเปิดเซิร์ฟใหม่กลับมาเหมือนเดิม (ตรงกับเกมจริงที่สัตว์เกิดใหม่เรื่อย ๆ)
/// </summary>
