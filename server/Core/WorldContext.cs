...
public class WorldContext
{
    ...
    ///
    /// [7 ก.ย. 2026] **id ซ้ำได้** — ซ้ำกี่ครั้ง = เก็บ generator ตัวนั้นไปแล้วกี่ครั้ง
    /// เดิมใส่ครั้งเดียวแล้วตัดออกจากเมนูทันที ⇒ ต้นไม้ต้นหนึ่งให้กิ่งไม้ได้แค่ครั้งเดียวทั้งต้น
    /// เก็บเป็น id ซ้ำแทนที่จะเปลี่ยนเป็น Dictionary&lt;string,int&gt; เพื่อให้ไฟล์เซฟเกาะเก่าอ่านต่อได้
    ///
